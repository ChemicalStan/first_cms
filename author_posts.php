...
$post_user=$_GET['post_user'];
  ...
  if(!empty($post_author)){
   $query="SELECT * FROM posts WHERE post_author = '{$post_author}'";}elseif(!empty($post_user)){
...
?>
                ...
                <p class="lead">
                    by <a href="author_posts.php?post_author=<?php echo $post_author;?>&post_id=<?php echo $post_id; ?>&post_user=<?php echo $post_user; ?>"><?php 
...
//                 
//    $query="INSERT INTO comment (comment_post_id,comment_author,comment_email,comment_content,comment_status,comment_date) VALUES ";
...
//    if(!$comment_count_query){die(mysqli_error($connection));}
//
//             }else{
//                 
